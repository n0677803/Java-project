...
public class Login extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(usernameinput, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void loginbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginbuttonActionPerformed
        ...
        try {
            ...
            ResultSet resset = statment.executeQuery("SELECT USERNAME FROM MSDB.USERTABLE");
            while (resset.next()) {
                if (resset.getString(1).equals(usernameinput.getText())) {
                    check = true;
                }
            }
            if (check == true) {
